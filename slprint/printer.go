...
// copied from go src/go/print/nodes.go:
...
// the evolving needs of go/format and cmd/gosl without breaking
...
const (
	...
	//
	// This value is known in and used by go/format and cmd/gosl.
